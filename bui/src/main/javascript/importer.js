...
//        }
    ...
    var addAllNodes = function(graph, data) {
        ...
        var addNode = function(nodeJSON, id) {
            ...
            if (nodeType.generator !== undefined) {
        ...
        for(var i = 0; i < nodes.length; i++) {
            ...
            try {
                ...
                if (nodeJSON.is_abstract === undefined ||
                        toBoolean(nodeJSON.is_abstract) === false) {
                    addNode(nodeJSON, getId(nodeJSON));
                } else {
                    abstractNodes[getId(nodeJSON)] = nodeJSON;
                }
            } catch (e) {
                console.log(e);
            }
                ...
                if (nodeJSON.data !== undefined &&
                    ...
                    for (var j = 0; j <  nodeJSON.data.subnodes.length; j++) {
                        ...
                        if (subNode === undefined &&
                            ...
                            var customId = getId(subNodeJSON) +
