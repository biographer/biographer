...
//   l.addPlugins(P_force_adj, P_torque_adj, P_distribute_edges, P_limit_mov);
   ...
   l.addStep();
   l.addPlugins(P_force_adj, P_distribute_edges, P_expand, P_push_components, P_limit_mov);
...
//   l.pluginScale(P_min_edge_crossing_multi, 0.1);
   ...
   l.addStep();
   l.addPlugins(P_force_adj, P_distribute_edges, P_force_compartments, P_adjust_compartments_fixed, P_expand, P_push_components, P_limit_mov);
   l.pluginScale(P_force_adj, 10);
